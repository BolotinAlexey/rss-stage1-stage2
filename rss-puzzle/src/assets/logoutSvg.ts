export default function logoutSvg(): string {
  ...
  <svg class="logout__svg" viewBox="0 0 48 48"><path fill = "red" d="M15.6,27c-0.2,0-0.4,0-0.6-0.1s-0.4-0.1-0.6-0.2c-0.2-0.1-0.4-0.2-0.5-0.3c-0.2-0.1-0.3-0.2-0.5-0.4
		...
		c0-0.9,0.7-1.6,1.6-1.6H22c0.9,0,1.6,0.7,1.6,1.6v6C23.6,15.7,24.9,17.1,26.6,17.1z"></path><path fill="currentColor" d="M47.3,25.2c0-0.1,0-0.1,0.1-0.2c0-0.1,0.1-0.2,0.1-0.4c0-0.2,0.1-0.4,0.1-0.6s0-0.4-0.1-0.6
